---
layout: post
title: 揭露动画效果Circular Reveal的使用及封装
excerpt: 揭露动画效果Circular Reveal的使用及封装
categories: Android
keywords: Android,Circular Reveal
---
## 使用
### 调用原生方法，常规使用
```
...
## 参考文章
[使用Circular Reveal为你的应用添加揭露动画效果](https://www.jianshu.com/p/57a7a5421b06)
[AndroidDemos](https://github.com/whyalwaysmea/AndroidDemos)
